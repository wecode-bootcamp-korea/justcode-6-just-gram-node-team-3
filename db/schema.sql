...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `comments_posting_id_fkey` (`posting_id`),
  KEY `comments_user_id_fkey` (`user_id`),
  CONSTRAINT `comments_posting_id_fkey` FOREIGN KEY (`posting_id`) REFERENCES `postings` (`id`),
...
CREATE TABLE `posting_images` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `posting_images_possting_id_fkey` (`posting_id`),
...
CREATE TABLE `postings` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `postings_user_id_fkey` (`user_id`),
